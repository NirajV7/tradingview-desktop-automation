...
FYERS_INDICATORS_5M = os.path.join(CWD, "fyers_indicators_5m.csv")
FYERS_INDICATORS_15M = os.path.join(CWD, "fyers_indicators_15m.csv")
ENGINE_LOG = os.path.join(CWD, "engine.log")
NIFTY_FEED_CSV = os.path.join(CWD, "nifty_50_feed.csv")
NIFTY_SPIKES_LOG = os.path.join(CWD, "nifty_spikes.log")
...
KITE_TOKEN_FILE = os.path.join(CWD, "kite_token.json")
